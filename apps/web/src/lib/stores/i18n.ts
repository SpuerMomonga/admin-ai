...
const textMessages = {
  ...
  cancel: m.cancel,
  collapse_admin_sidebar: m.collapse_admin_sidebar,
  ...
  dashboard_metric_active_base: m.dashboard_metric_active_base,
  dashboard_metric_active_base_copy: m.dashboard_metric_active_base_copy,
  dashboard_metric_in_progress: m.dashboard_metric_in_progress,
  dashboard_metric_in_progress_copy: m.dashboard_metric_in_progress_copy,
  dashboard_metric_primary_model: m.dashboard_metric_primary_model,
  dashboard_metric_primary_model_copy: m.dashboard_metric_primary_model_copy,
  dashboard_metric_total_tasks: m.dashboard_metric_total_tasks,
  dashboard_metric_total_tasks_copy: m.dashboard_metric_total_tasks_copy,
  dashboard_operating_posture_description: m.dashboard_operating_posture_description,
  dashboard_operating_posture_title: m.dashboard_operating_posture_title,
  dashboard_recent_tasks_empty: m.dashboard_recent_tasks_empty,
  dashboard_recent_tasks_title: m.dashboard_recent_tasks_title,
  dashboard_task_mode_label: m.dashboard_task_mode_label,
  delete_task: m.delete_task,
  downvote_message: m.downvote_message,
  enter_workspace: m.enter_workspace,
  expand_admin_sidebar: m.expand_admin_sidebar,
  ...
  rename_task_description: m.rename_task_description,
  ...
  task_title_label: m.task_title_label,
